var angularApp = angular.module('wonoma', [
	'ngRoute',
	'ngSanitize',
	'httpInterceptor',
	'resources',
...
angularApp.run(['security', '$templateCache', '_', 'ui.config',
    function(security, $templateCache, _, uiConfig) {

	security.requestCurrentUser(false);
